...
sideinfo2 = Label(f[8, 2:3], "Quantile level (α)", fontsize = 30)
...
l = Legend(f[8, 1:2],obj_scatter,["q̲ᵈ ","q̄ᵈ ","π̲  α-VaR performance","π̄  α-VaR performance"],orientation = :horizontal)
