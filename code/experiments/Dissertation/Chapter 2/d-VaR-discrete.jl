...
histogram(dist_left, xlabel="x (Return)", ylabel="Frequency", title="Quantile of Discrete Distribution", ylims=(0,4), xlims=(0,4),bins=0.5:1:3.5, color=:lightblue, edgecolor=:black, label="Left of 50% Quantile")
xticks!(1:3)
